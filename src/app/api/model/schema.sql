...
-- Sample blog post
INSERT INTO blog_posts (title, slug, excerpt, content, tags, published, published_at) VALUES (
  'Building a Portfolio with Next.js and Supabase',
  'building-portfolio-nextjs-supabase',
  'A walkthrough of how I built this portfolio using Next.js 14, Supabase, and Tailwind CSS.',
  '## Introduction\n\nIn this post I will walk you through how I built this portfolio from scratch using modern tools.\n\n## Stack\n\n- **Next.js 14** for the frontend\n- **Supabase** for the database and auth\n- **Tailwind CSS** for styling\n\n## Conclusion\n\nThis stack is a great choice for solo developers who want to ship fast.',
