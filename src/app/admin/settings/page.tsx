...
interface Settings {
  name: string; title: string; bio: string; email: string; location: string
  avatar_url: string; cv_url: string; open_to_work: boolean; availability_message: string
...
export default function AdminSettings() {
  ...
  useEffect(() => {
    fetch('/api/admin/settings').then(r => r.json()).then(d => {
      setSettings(d.data); setLoading(false)
    })
  }, [])
